...
populationres3 = 1577
populationres4 = 152
populationaltmig2 = 5466
populationaltmig3 = 2463
populationaltmig4 = 299
populationmig1 = 8000
populationmig2 = 2800
populationmig3 = 900
populationmig4 = 75
...
for (year in (1:20)/2) {
  ...
  populationres2<-Res2summer(r=0.7,initialR2=populationres2,K2s=3525,alpha=0.2,initialAM2=populationaltmig2)
  ...
  populationaltmig2<-Alt_Migrant2summer(r=0.7,initialAM2=populationaltmig2,K2s=3525,sigma = 0.1,initialR2 = populationres2)
  populationaltmig3<-Alt_Migrant3summer(r=0.7,initialAM3=populationaltmig3,K3s=2175,sigma = 0.1,initialR3 = populationres3)
  populationaltmig4<-Alt_Migrant4summer(r=0.7,initialAM4=populationaltmig4,K4s=226,sigma = 0.1,initialR4 = populationres4)
  populationmig1<-Migrant1summer(r=0.7,initialM1=populationmig1,B=12000,beta = 0.1,initialM2 = populationmig2,initialM3 = populationmig3,initialM4 = populationmig4)
  populationmig2<-Migrant2summer(r=0.7,initialM2=populationmig2,B=12000,beta = 0.1,initialM1 = populationmig1,initialM3 = populationmig3,initialM4 = populationmig4)
  populationmig3<-Migrant3summer(r=0.7,initialM3=populationmig3,B=12000,beta = 0.1,initialM1 = populationmig1,initialM2 = populationmig2,initialM4 = populationmig4)
  populationmig4<-Migrant4summer(r=0.7,initialM4=populationmig4,B=12000,beta = 0.1,initialM1 = populationmig1,initialM2 = populationmig2,initialM3 = populationmig3)
  }
  else {
  populationres1<-Res1winter(r=0.7,initialR1=populationres1, alpha=0.1,initialAM2 = populationaltmig2, beta = 0.1, initialM1 = populationmig1, K1w=9215)
  populationres2<-Res2winter(r=0.7,initialR2=populationres2, alpha=0.1, initialAM3 = populationaltmig3, beta=0.1, initialM2 = populationmig2,K2w=2185)
  populationres3<-Res3winter(r=0.7,initialR3=populationres3, alpha=0.1, initialAM4 = populationaltmig4, beta=0.1, initialM3 = populationmig3,K3w=1485)
  populationres4<-Res4winter(r=0.7,initialR4=populationres4, beta=0.1, initialM4 = populationmig4, K4w=153)
  populationaltmig2<-Alt_Migrant2winter(r=0.7, initialAM2 = populationaltmig2, sigma=0.1, initialR1=populationres1, beta=0.1, initialM1 = populationmig1, K1w=9215)
  populationaltmig3<-Alt_Migrant3winter(r=0.7, initialAM3=populationaltmig3, sigma=0.1, initialR2=populationres2, beta=0.1, initialM2=populationmig2, K2w=2185)
  populationaltmig4<-Alt_Migrant4winter(r=0.7, initialAM4=populationaltmig4, sigma=0.1, initialR3=populationres3, beta=0.1, initialM3 = populationmig3, K3w=1485)
  populationmig1<-Migrant1winter(r=0.7, initialM1=populationmig1, alpha=0.1, initialAM2 = populationaltmig2, sigma=0.1, initialR1=populationres1,K1w=9215)
  populationmig2<-Migrant2winter(r=0.7, initialM2=populationmig2, alpha=0.1, initialAM3 = populationaltmig3, sigma=0.1, initialR2=populationres2,K2w=2185)
  populationmig3<-Migrant3winter(r=0.7, initialM3=populationmig3, alpha=0.1, initialAM4 = populationaltmig4, sigma=0.1, initialR3=populationres3,K3w=1485)
  populationmig4<-Migrant4winter(r=0.7, initialM4=populationmig4, sigma=0.1, initialR4=populationres4, K4w=153)
  }
