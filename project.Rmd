...
for (year in 1:20) {
  ...
  populationres4<-Res4summer(r=0.7,initialR4=populationres4,K4s=226,alpha=0.2,initialM4 = populationmig4)
   populationmig2<-Migrant2summer(r=0.3,initialM2=populationmig2,K2s=4525,alpha = 0,initialR2 = populationres2)
   populationmig3<-Migrant3summer(r=0.3,initialM3=populationmig3,K3s=2175,alpha = 0,initialR3 = populationres3)
   populationmig4<-Migrant4summer(r=0.3,initialM4=populationmig4,K4s=226,alpha = 0,initialR4 = populationres4)
  }
  else {
  ...
  populationmig2<-Migrant2winter(r=0.3,alpha=0,initialR1=populationres1,initialM2=populationmig2,K1w=9215)
  populationmig3<-Migrant3winter(r=0.3,alpha=0,initialR2=populationres2,initialM3=populationmig3,K2w=3185)
  populationmig4<-Migrant4winter(r=0.3,alpha=0,initialR3=populationres3,initialM4=populationmig4,K3w=1485)
  }
  year_vector<-append(year_vector,year)
  populationres1_vector<-append(populationres1_vector,populationres1)
  populationres2_vector<-append(populationres2_vector,populationres2)
